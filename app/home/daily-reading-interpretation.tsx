...
const dailyLogo = '../../assets/svg/reading/daily.svg';

export default function DailyReadingInterpretation() {
      ...
      <HeaderBar
        title={
          <View style={{ height: 70, position: 'relative' }}>
            ...
            >
              <Image source={require(dailyLogo)} style={{ width: 78, height: 78 }} />
            </View>
            <View style={{ position: 'absolute', top: '10%', left: '10%' }}>
              <Image source={require(bookIcon)} style={{ width: 55, height: 55 }} />
            </View>
          </View>
        }
      />
        ...
        >
          ...
          >
            ...
            >
              <View style={[Styles.leftChat, Styles.shadow]}>
                <TextWrapper style={{ color: 'white', fontSize: 13 }}>
                  {t('dailyReadingInterpretationDescription1')}
                </TextWrapper>
              </View>
              {renderCtl()}
            </View>
          ...
          >
            ...
            >
              <View style={[Styles.leftChat, Styles.shadow]}>
                <TextWrapper style={{ color: 'white', fontSize: 13 }}>
                  {t('dailyReadingInterpretationDescription2')}
                </TextWrapper>
              </View>
              {renderCtl()}
            </View>
